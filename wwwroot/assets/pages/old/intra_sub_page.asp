...
<div class="content">
        ...
        <h3>Department of Economic Development</h3>

        <p>DED requires each traveler to submit a Travel Authorization (TA) from within the 
        online Statewide Financial System (SFS).  Completion of the TA will eliminate the paper process between the traveler and approvers for 
        <b>in-State</b> business travel.</p>
            
        <p>When travelling out of State, paper submission of the <a href="">Request for Out-of-State-Travel Approval...</a>
