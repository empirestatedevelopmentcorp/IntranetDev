...
<script>
  ...
  <style>.ui-accordion .ui-accordion-header {
    display: block;
    cursor: pointer;
    position: relative;
    margin: 2px 0 0 0;
...
<div class="content">
        ...
        <h1>Esd Intranet - Accordion Sample fo RFQ Template</h1>
        
        <h3>For long scrolling pages</h3>
        <div id="accordion">
          <h3>INTRODUCTION</h3>
          <div>
            <p>
          ...
          <div>
            <p>
              ...
              New York State certified Minority- and Women-Owned Businesses (MWBEs) and Service Disabled Veteran Owned Businesses (SDVOBs) may request that their firm’s contact information be included on a list of MWBE and SDVOB firms interested in serving as a subcontractor for this procurement. The listing will be publicly posted on ESD’s website for reference by the bidding community. A firm requesting inclusion on this list should send contact information and a copy of its NYS MWBE or SDVOB certification to XXX@esd.ny.gov. Nothing prohibits an M/WBE Vendor from proposing as a prime contractor.
            </p>
          </div>
          <h3>SUBMISSION OF PROPOSALS</h3>
          <div>
            <p>
              Every respondent to this RFP (“Bidder”) should submit a proposal which clearly and concisely provides all of the information requested.  Emphasis should be concentrated on conformance to the RFP instructions and requirements, as well as completeness and clarity in its proposal response.  The Bidder is advised to thoroughly read and follow all instructions contained in this RFP.  Proposals that do not comply with these instructions or do not meet the full intent of all the requirements of this RFP may be subject to scoring reductions during the evaluation process or may be deemed non-responsive. 
            </p>
            <ul>
              <li>List item one</li>
              <li>List item two</li>
...
Questions or requests for clarification regarding the RFP should be submitted via email, citing the RFP page and section in accordance with the schedule in Section IV (Schedule of Dates) to XXX@esd.ny.gov. Questions will not be accepted orally and any question received after the deadline may not be answered. The comprehensive list of questions/requests for clarifications and the official responses will be posted with this RFP.
            </p>
            <p>
            Suspentaciti sociosqu ad litora torquent per conubia nostra, per
            inceptos himenaeos.
            </p>
          </div>
        </div>
...
<br />
        ...
        <h3>Could be used for FAQs</h3>
        <div id="accordion2">
          <h3>Question: Will all staff be reporting to the new office on the same day, or will the move be staggered by floors/
            departments?</h3>
          <div>
            <p>
              Answer: Details on how the move will take place are still being worked out. Information regarding those details will be
              provided as we get closer to move in.
            </p>
          </div>
          <h3>Question: Do we need new security passes for 655? </h3>
          <div>
            <p>
              Answer: Yes, new passes will be issued for the new building. The Administration team will be reaching out to staff over
              the next several weeks to update pictures for ID badges where needed. 
            </p>
          </div>
          <h3>Question: What are the sizes of the workstations/offices</h3>
          <div>
            <p>
              Answer: The standard workstation has an adjustable height 78” x 30” work surface, with two 24” file drawers. Private
              Offices have an adjustable height 52”x27’ work surface with a 72”x30” side work surface, and two 42” wide file drawers.
            </p>
