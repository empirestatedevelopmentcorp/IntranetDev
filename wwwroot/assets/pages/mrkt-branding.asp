...
<head>
    <title>Economic Analysis & Research</title>
    <meta charset="utf-8">
...
<body style="background-color: #f3f3f3;">
   ...
   <!-- === 2nd level custom content area ===  -->
    ...
    <div class="content">
        ...
        <h1>Marketing Guidelines, Branded Templates, Logos</h1>
    <div class="row">
            <div class="esd-3-col gr mh">
              <h2 class="wh">Marketing</h2>
            </div>
      
            <div class="esd-3-col dg-blue mh">
              <h2 class="wh">Templates</h2>
            </div>
      
            <div class="esd-3-col yw mh">
              <h2 class="bk">Logos</h2>
